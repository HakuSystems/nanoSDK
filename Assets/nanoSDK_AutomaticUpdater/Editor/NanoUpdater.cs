...
namespace nanoSDK
{
    ...
    { //api features in here bc files will be delted when process is being made
        ...
        public static async Task UpdateVersionData()
        {
            ...
            LatestVersion = await GetLatestVersion(SdkVersionBaseINTERNDATA.ReleaseType.Avatar, SdkVersionBaseINTERNDATA.BranchType.Release);
            LatestBetaVersion = await GetLatestVersion(SdkVersionBaseINTERNDATA.ReleaseType.Avatar, SdkVersionBaseINTERNDATA.BranchType.Beta);
        }
